...
public class Handler {
    ...
    private static Color[] colors = { color(0, 100, 100), color(240, 100, 100), color(300, 100, 100),   
	color(0, 100, 76.9), color(240, 100, 76.9), color(300, 100, 76.9), 
	color(0, 100, 53.7), color(240, 100, 53.7), color(300, 100, 53.7)
    };
...
//		System.out.println("Calculating function "+(e+1)+"...");
	...
	System.out.println("Tiempo de ejecucion: "+(System.nanoTime()-ntime));
    }
